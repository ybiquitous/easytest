...
test "to_have_attributes" do
  expect { subject("あ").to_have_attributes size: 1, bytesize: 3 }.to_raise_nothing
  expect { subject("あ").to_have_attributes size: 1, bytesize: 2 }.to_raise "have attributes"
end

test "not.to_have_attributes" do
  expect { subject("あ").not.to_have_attributes size: 2 }.to_raise_nothing
